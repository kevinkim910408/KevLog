...
<div className="my-1 flex w-full justify-center overflow-hidden px-2 xl:my-1 xl:w-1/2 xl:px-2">
  ![Github
  Traffic](https://firebasestorage.googleapis.com/v0/b/kevlog-cdd91.appspot.com/o/project%2Fnyx_console.PNG?alt=media&token=0df78cac-d0f5-4d77-af73-521af751ffae)
</div>
...
Vite, Nest, Typescript, React-query, Redux, MongoDB
